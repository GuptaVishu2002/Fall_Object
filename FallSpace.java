...
class FallJSS5 {
    ...
    public static void main(String args[]) {
        ...
        try{
        	...
        	System.out.print("”òãÄ•¨‘Ì‚Ì”‚ð“ü—Í‚µ‚Ä‚­‚¾‚³‚¢(>:");
        	buf = br.readLine();
			...
			for(int i=0; i<MaxObj; ++i){
				System.out.print((i+1) + "‘Ì–Ú‚ÌX•ûŒü‚Ì‰‘¬‚ð“ü—Í‚µ‚Ä‚­‚¾‚³‚¢[m]:");
				buf = br.readLine();
				x_speed[i] = Integer.parseInt(buf);
				
				System.out.print((i+1) + "‘Ì–Ú‚Ìy•ûŒü‚Ì‰Šú’l‚ð“ü—Í‚µ‚Ä‚­‚¾‚³‚¢:[m]:");
				buf = br.readLine();
			...
			for(int i=0; i<MaxObj; ++i)
				System.out.println("”òãÄ•¨‘Ì"+(i+1)+"‚Ì—Ž‰º—\‘ª’n“_[m]:" + x[i]);
